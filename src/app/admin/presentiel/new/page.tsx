// src/app/admin/presentiel/new/page.tsx
"use client";
...
import { createPresentielCourse } from "@/actions/presentiel.actions";
import RichTextEditor from "@/components/RichTextEditor";

export default function NewPresentielCourse() {
  ...
  const[included, setIncluded] = useState<string[]>(["Support de cours", "Certificat"]);
  ...
  const handleSave = async () => {
    ...
    const result = await createPresentielCourse(payload);

    setSaving(false);

    if (result.success) {
      alert("Formation en présentiel créée avec succès !");
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Nouvelle Formation en Présentiel</h1>
            <p className="text-slate-600">Créez une nouvelle formation en présentiel</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: Développement Web Complet - Formation Présentielle"
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: Formation intensive de 3 mois en présentiel"
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:border-[#001f5f] focus:ring-2 focus:ring-blue-200 outline-none"
              />
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Durée (Ex: 3 mois)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Places maximum</label>
                <input
                  type="number"
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Lundi - Mercredi: 9h00 - 15h00"
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:border-[#001f5f] focus:ring-2 focus:ring-blue-200 outline-none"
                />
              </div>
            </div>
            ...
            {objectives.map((obj, index) => (
              <div key={index} className="flex gap-2">
                <input
                  ...
                  placeholder="Ex: Maîtriser HTML/CSS"
                  className="flex-1 px-4 py-2 border border-slate-200 rounded-lg outline-none focus:border-[#001f5f]"
                />
